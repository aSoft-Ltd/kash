...
subprojects {
    ...
    configure<MavenPublishBaseExtension> {
        ...
        pom {
            ...
            url.set("https://github.com/aSoft-Ltd/kash")
            licenses {
                license {
                    name.set("MIT License")
                    url.set("https://github.com/aSoft-Ltd/kash/blob/master/LICENSE")
                }
            }
            developers {
                developer {
            ...
            scm {
                url.set("https://github.com/aSoft-Ltd/kash/")
                connection.set("scm:git:git://github.com/aSoft-Ltd/kash.git")
                developerConnection.set("scm:git:ssh://git@github.com/aSoft-Ltd/kash.git")
            }
        }
    }
}