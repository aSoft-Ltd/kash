...
@JsName("moneyOf")
@JvmName("of")
inline fun Money(amount: Double, currency: Currency): Money = MoneyImpl((amount * currency.lowestDenomination).toULong(), currency)
...
@JvmName("of")
inline fun Money(amount: Int, currency: Currency): Money = MoneyImpl((amount.toDouble() * currency.lowestDenomination).toULong(), currency)

@JvmName("of")
inline fun Money(amount: Int): Monetary = MonetaryImpl((amount.toDouble() * MONETARY_LOWEST_DENOMINATION).toULong())

@JvmName("of")
inline fun Money(amount: Long, currency: Currency): Money = MoneyImpl((amount.toDouble() * currency.lowestDenomination).toULong(), currency)
